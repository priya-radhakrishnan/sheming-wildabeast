...
({
	1: [function (require, module, exports) {
		'use strict';
		var app = angular.module('app', ['ui.router', 'angularCharts', 'ngAnimate', "mm.foundation", 'ui.slider', 'countTo']).run(['$rootScope', '$state', '$stateParams', function ($rootScope, $state, $stateParams) {
			$rootScope.$state = $state;
			$rootScope.$stateParams = $stateParams;
		}]).config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
			$urlRouterProvider.otherwise('energy-trends/test');
			$stateProvider.state('overview', {
				...
				url: '/test',
				menu: true,
				templateUrl: 'app/partials/energy-trends/_test-v2.html'
			}).state('overTimeCosts', {
				parent: 'overTime',
				label: 'Costs',
				url: '/',
				...
				menu: true,
				locked: true,
				templateUrl: 'app/partials/energy-trends/by-category/index.html'
			}).state('waysToSave', {
				label: 'Ways to Save',
				url: '/ways-to-save',
				menu: true,
		...
		app.controller('ceVisionController', ['$scope', '$state', '$window', function ($scope, $state, $window) {
		...
		app.controller('recentTrendsController', ['$scope', function ($scope) {
			$scope.recentTrends = [{
				...
				miniGraphType: 'bar',
				graphData: [
				60, 50, 52, 70, 100, 65, 60, 50, 52, 45]
			}];
		}]);
		...
		app.controller('insightCardsController', ['$scope', '$modal', '$rootScope', '$element', 'insightCardService', function ($scope, $modal, $rootScope, $element, insightCardService) {
			$scope.open = function () {
		...
		app.directive('opBarGraph', ['$animate', '$timeout', function ($animate, $timeout) {
			return {
				...
				scope: {
					...
					topvalue: '=',
					showWeather: '=',
					changeParentChartView: '&',
					updateParentActiveDay: '&'
				},
	...
	/**
	 *
	 * This file is one big object
	 *
	 * The Contents
	 *
	 * 1:  the "app"
	 * 2: cost day 				controller
	 * 3: cost month 			controller
	 * 3: cost year 			controller
	 * 5: overTimeGraph		controller  ????
	 * 6: usage day 			controller
	 * 7: usage month 		controller
	 * 8: usage year 			controller
	 *
	 * 9:  data
	 * 10: data
	 * 11: data
	 ...
	 * 14: data
	 *
	 * 15: general 					chart config
	 * 16: cost 						chart config
	 * 17: usage 						chart config
	 * 18: usage neighbour 	chart config
	 *
	 * 28: solar day 			controller
	 * 29: solar month 		controller
	 * 30: solar year 		controller
	 * 31: solar 					chart config
	 * 32: solar year 	data
	 * 33: solar month 	data
	 * 34: solar day 		data
	 *
	 *
	 * 50: carbon day 			controller
	 * 51: carbon month 		controller
	 * 52: carbon year 		controller
	 * 54: carbon 					chart config ??? use 31
	 * 55: carbon year 	data
	 * 56: carbon month 	data
	 * 57: carbon day 		data
	 *
	 *
	 * 19: Highcharts.js
	 * 20: HighchartsAdapter
	 * 21: drilldown.js
	 * 22: lodash.js    ~19900 - End of document
	 *
	 **/
		...
		//costs
		require('../app/controllers/over-time-graph.js');
		require('../app/controllers/cost-year.js');
		require('../app/controllers/cost-month.js');
		require('../app/controllers/cost-day.js');
		require('../app/features/op-cost-chart.js');

		//usage
		require('../app/controllers/usage-year.js');
		require('../app/controllers/usage-month.js');
		require('../app/controllers/usage-day.js');
		require('../app/features/op-usage-chart.js');
		require('../app/features/op-usage-neighbors-chart.js');

		//solar
		require('../app/controllers/mkr-cont-solar-day.js');
		require('../app/controllers/mkr-cont-solar-month.js');
		require('../app/controllers/mkr-cont-solar.js');
		require('../app/features/mkr-feat-solar-chart.js');

		//carbon
		require('../app/controllers/mkr-cont-carbon-day.js');
		...
		"../app/controllers/cost-month.js": 3,
		"../app/controllers/cost-year.js": 4,
		"../app/controllers/over-time-graph.js": 5,
		"../app/controllers/usage-day.js": 6,
		"../app/controllers/usage-month.js": 7,
		"../app/controllers/usage-year.js": 8,
		"../app/features/op-cost-chart.js": 16,
		"../app/features/op-usage-chart.js": 17,
		"../app/features/op-usage-neighbors-chart.js": 18,

		"../app/controllers/mkr-cont-solar-day.js": 28,
		"../app/controllers/mkr-cont-solar-month.js": 29,
		"../app/controllers/mkr-cont-solar.js": 30,
		"../app/features/mkr-feat-solar-chart.js": 31,
	...
	3: [function (require, module, exports) {
		...
		app.controller('costMonthController', ['$scope', function ($scope) {
			...
			/**
				* hack the graph and highlight a few culomns
			...
			function startBlue() {
				for(var i = 0; i < chartData.series[0].data.length; ++i) {
					$scope.costFebruary.series[0].data[i].color = noHighlightColor;
			...
			var index;
			var chartSeries = chartData.series[0].data.length;
			for (index = 0; index < chartSeries; ++index) {
				$scope.weatherFebruary.push(parseInt(chartData.series[0].data[index].temp));
			}
		}]);
	}, {
		"../app": 1,
		"../data/cost-months/cost-february.json": 11
	}],
	...
	5: [function (require, module, exports) {
		...
		"../app": 1,
		"../data/usage-current-year.json": 12,
		"Highcharts": 20
	}],
	...
	7: [function (require, module, exports) {
		...
		"../app": 1,
		"../data/usage-months/usage-february.json": 14
	}],
	...
	50: [function (require, module, exports) {
		'use strict';
		var app = require('../app');
		var chartData = require('../data/carbon-day.json');
		app.controller('mkrCarbonDayController', ['$scope', function ($scope) {
			$scope.mkrCarbonDay = chartData;
		}]);
	}, {
		"../app": 1,
		"../data/carbon-day.json": 55
	}],

	51: [function (require, module, exports) {
		'use strict';
		var app = require('../app');
		var chartData = require('../data/carbon-months/carbon-february.json');
		app.controller('mkrCarbonMonthController', ['$scope', function ($scope) {
			$scope.mkrCarbonFebruary = chartData;
		}]);
	}, {
		"../app": 1,
		"../data/carbon-months/carbon-february.json": 56
	}],

	52: [function (require, module, exports) {
		'use strict';
		var app = require('../app');
		var chartData = require('../data/carbon-current-year.json');
		app.controller('mkrCarbonYearController', ['$scope', function ($scope) {
			$scope.mkrCarbonYear = chartData;
		}]);
	}, {
		"../app": 1,
		"../data/carbon-current-year.json": 57
	}],
		...
		function chartTheme() {
			return {
				neighborSettings: {
					YOU: {
						lineColor: '#107cb2',
						fillColor: 'rgba(174,216,239,0.85)',
						zIndex: 3,
						lineWidth: 4,
						dashStyle: 'Solid'
					},
						...
						tooltip: {
							...
							positioner: function (boxWidth, boxHeight, point) {
								var i = $scope.activePointIndex,
									...
									highestPointY = Math.min(
										chart.series[0].points[i].plotY, chart.series[1].points[i].plotY);
								return {
							...
							formatter: function () {
								...
								var ci_header_tool;
										...
										if(insight && insight.disposition == 'positive') {
											insightIcon = 'circle-check';
											ci_header_tool = 'tooltip-header';
										} else if (insight && insight.disposition == 'psd') {
											insightIcon = '';
											ci_header_tool = 'tooltip-header ci';
										} else {
											insightIcon = 'circle-warn';
											ci_header_tool = 'tooltip-header';
										}
...
/*
									insightIcon = if(insight && insight.disposition == 'positive') {
											'smiley-great';
										} else if(insight && insight.disposition == 'neutral') {
											'smiley-good';
										} else if (insight && insight.disposition == 'psd') {
											'';
										} else {
...
*/
  ...
  insightIcon = (insight && insight.disposition == 'positive') ? 'smiley-great' : (insight && insight.disposition == 'neutral') ? 'smiley-good' : 'circle-warn';
		...
		var app = require('../app'),
			...
			_ = require('lodash');
		require('../../js/vendor/highcharts/js/modules/drilldown.js');
		app.directive('opCarbonChart', function () {
			return {
				restrict: 'A',
				scope: {
					chartData: '=',
...
*/
	 ...
	 * 17: usage 						chart config
	 * 18: usage neighbour 	chart config
	 * 58: carbon neighbour 	chart config
	 * 59: carbon 						chart config
	 *
	 * 28: solar day 			controller
	 * 29: solar month 		controller
	 * 30: solar year 		controller
	...
	28: [function (require, module, exports) {
		...
		"../app": 1,
		"../data/mkr-data-solar-day.json": 34
	}],

	//this is equal to 7:
	//SOLAR MONTH CONTROLLER
	29: [function (require, module, exports) {
		...
		"../app": 1,
		"../data/solar-months/mkr-data-solar-february.json": 33
	}],

	//this is equal to 8:
	//SOLAR YEAR CONTROLLER
	...
	20: [function (require, module, exports) {
		(function (global) {;
			HighchartsAdapter = global.HighchartsAdapter = require("/Users/justin.secor/Projects/Nextweb/js/vendor/highcharts/js/adapters/standalone-framework.src.js");;
			__browserify_shim_require__ = require;
			(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
				// ==ClosureCompiler==
				...
				(function () {
					...
					var UNDEFINED, doc = document,
						...
						makeTime, timezoneOffset, getTimezoneOffset, getMinutes, getHours, getDay, getDate, getMonth, getFullYear, setMinutes, setHours, setDate, setMonth, setFullYear,
					...
					Highcharts.numberFormat = function (number, decimals, decPoint, thousandsSep) {
						var lang = defaultOptions.lang,
							...
							n = +number || 0,
							c = decimals === -1 ? mathMin((n.toString().split('.')[1] || '').length, 20) : // Preserve decimals. Not huge numbers (#3793).
					...
					pathAnim = {
						...
						init: function (elem, fromD, toD) {
							...
							var shift = elem.shift,
								...
								endLength, slice, i, start = fromD.split(' '),
								end = [].concat(toD),
								// copy
							...
							init: function (pathAnim) {
								...
								$.fn.highcharts = function () {
									...
									if (this[0]) {
										...
										options = args[0];
										// Create the chart
										if (options !== UNDEFINED) { /*jslint unused:false*/
					...
					SVGElement.prototype = {
						...
						textProps: ['fontSize', 'fontWeight', 'fontFamily', 'color', 'lineHeight', 'width', 'textDecoration', 'textShadow'],
						/**
						...
						colorGradient: function (color, prop, elem) {
							var renderer = this.renderer,
								colorObject, gradName, gradAttr, gradients, gradientObject, stops, stopColor, stopOpacity, radialReference, n, id, key = [];
						...
						applyTextShadow: function (textShadow) {
							var elem = this.element,
								tspans, hasContrast = textShadow.indexOf('contrast') !== -1,
						...
						attr: function (hash, val) {
							var key, value, element = this.element,
						...
						updateShadows: function (key, value) {
							...
							while (i--) {
								shadows[i].setAttribute(
									key, key === 'height' ? mathMax(value - (shadows[i].cutHeight || 0), 0) : key === 'd' ? this.d : value);
							}
						},
						/**
						...
						crisp: function (rect) {
							var wrapper = this,
								key, attribs = {},
								normalizer, strokeWidth = rect.strokeWidth || wrapper.strokeWidth || 0;
						...
						getBBox: function (reload) {
							var wrapper = this,
								...
								textShadow, elemStyle = element.style,
								toggleTextShadowShim, cacheKey;
							...
							if (!bBox) {
								...
								if (element.namespaceURI === SVG_NS || renderer.forExport) {
									try { // Fails in Firefox if the container has display: none.
										...
										toggleTextShadowShim = this.fakeTS &&
											function (display) {
					...
					SVGRenderer.prototype = {
						...
						buildText: function (wrapper) {
							var textNode = wrapper.element,
								...
								styleRegex, hrefRegex, parentX = attr(textNode, 'x'),
											...
											if (span !== ' ') {
												...
												if (width) {
													var words = span.replace(/([^\^])-/g, '$1- ').split(' '),
														...
														tooLong, wasTooLong, actualWidth, rest = [],
						...
						button: function (text, x, y, callback, normalState, hoverState, pressedState, disabledState, shape) {
							var label = this.label(text, x, y, shape, null, null, null, null, 'button'),
								curState = 0,
								stateOptions, stateStyle, normalStyle, hoverStyle, pressedStyle, disabledStyle, verticalGradient = {
									x1: 0,
									y1: 0,
									x2: 0,
									y2: 1
						...
						symbol: function (symbol, x, y, width, height, options) {
							var obj,
								...
								imageElement, imageRegex = /^url\((.*?)\)$/,
								imageSrc, imageSize, centerImage;
							if (path) {
								obj = this.path(path);
						...
						symbols: {
							...
							callout: function (x, y, w, h, options) {
								var arrowLength = 6,
									...
									path, normalizer = mathRound(options.strokeWidth || 0) % 2 / 2; // mathRound because strokeWidth can sometimes have roundoff errors;
								x += normalizer;
								y += normalizer;
					...
					extend(SVGElement.prototype, {
						...
						htmlUpdateTransform: function () {
							...
							if (elem.tagName === 'SPAN') {
								var width, rotation = wrapper.rotation,
									baseline, textWidth = pInt(wrapper.textWidth),
						...
						VMLElement = {
							...
							shadow: function (shadowOptions, group, cutOff) {
								var shadows = [],
									...
									shadow, elemStyle = element.style,
									markup, path = element.path,
					...
					SVGRenderer.prototype.measureSpanWidth = function (text, styles) {
						var measuringSpan = doc.createElement('span'),
							offsetWidth, textNode = doc.createTextNode(text);
					...
					Tick.prototype = {
						...
						addLabel: function () {
							...
							// first call
							if (!defined(label)) {
								tick.label = label = defined(str) && labelOptions.enabled ? chart.renderer.text(
										str, 0, 0, labelOptions.useHTML)
									//.attr(attr)
						...
						render: function (index, old, opacity) {
							var tick = this,
								...
								gridLinePath, mark = tick.mark,
								markPath, step = /*axis.labelStep || */
								labelOptions.step,
								attribs, show = true,
							...
							if (optionsLabel && defined(optionsLabel.text) && path && path.length && axis.width > 0 && axis.height > 0) {
								...
								if (!label) {
									...
									plotLine.label = label = renderer.text(
										optionsLabel.text, 0, 0, optionsLabel.useHTML).attr(attribs).css(optionsLabel.style).add();
								}
					...
					Axis.prototype = {
						...
						getMinorTickPositions: function () {
							...
							if (range && range / minorTickInterval < axis.len / 3) { // #3875
								if (axis.isLog) {
									...
									minorTickPositions = minorTickPositions.concat(
										axis.getTimeTicks(
											axis.normalizeTimeTickInterval(minorTickInterval), min, max, options.startOfWeek));
								} else {
									...
									each(axis.series, function (series) {
										...
										if (!axis.single) {
											...
											minPointOffset = mathMax(
												minPointOffset, isString(pointPlacement) ? 0 : seriesPointRange / 2);
						...
						setTickInterval: function (secondPass) {
							...
							if (axis.min === axis.max || axis.min === undefined || axis.max === undefined) {
								...
								axis.tickInterval = pick(
									tickIntervalOption, this.tickAmount ? ((axis.max - axis.min) / mathMax(this.tickAmount - 1, 1)) : undefined, categories ? // for categoried axis, 1 is default, for linear axis use tickPix
									1 :
							...
							if (!tickPositions) {
								if (this.isDatetimeAxis) {
									tickPositions = this.getTimeTicks(
										this.normalizeTimeTickInterval(this.tickInterval, options.units), this.min, this.max, options.startOfWeek, this.ordinalPositions, this.closestPointRange, true);
								} else if (this.isLog) {
						...
						unsquish: function () {
							...
							if (horiz) {
								autoRotation = defined(rotationOption) ? [rotationOption] : slotSize < 80 && !labelOptions.staggerLines && !labelOptions.step && labelOptions.autoRotation;
								if (autoRotation) {
						...
						renderUnsquish: function () {
							var chart = this.chart,
								...
								horiz = this.horiz,
								margin = chart.margin,
								slotWidth = this.slotWidth = (horiz && !labelOptions.step && !labelOptions.rotation && ((this.staggerLines || 1) * chart.plotWidth) / tickPositions.length) || (!horiz && ((margin[3] && (margin[3] - chart.spacing[3])) || chart.chartWidth * 0.33)),
								// #1580, #1931,
						...
						getOffset: function () {
							...
							axisOffset[side] = mathMax(
								axisOffset[side], axis.axisTitleMargin + titleOffset + directionFactor * axis.offset, labelOffsetPadded // #3027
							);
						...
						destroy: function (keepEvents) {
							var axis = this,
								stacks = axis.stacks,
								stackKey, plotLinesAndBands = axis.plotLinesAndBands,
								i;
							// Remove the events
							if (!keepEvents) {
								removeEvent(axis);
						...
						drawCrosshair: function (e, point) { // docs: Missing docs for Axis.crosshair. Also for properties.
							...
							if (
								...
								} else if (defined(point)) { /*jslint eqeq: true*/
					...
					Axis.prototype.getTimeTicks = function (normalizedInterval, min, max, startOfWeek) {
						...
						if (defined(min)) { // #1300
							minDate.setMilliseconds(interval >= timeUnits.second ? 0 : count * mathFloor(minDate.getMilliseconds() / count)); // #3652, #3654
					...
					Axis.prototype.normalizeTimeTickInterval = function (tickInterval, unitsOption) {
						...
						count = normalizeTickInterval(
							tickInterval / interval, multiples, unit[0] === 'year' ? mathMax(getMagnitude(tickInterval / interval), 1) : 1 // #1913, #2360
						);
						return {
							unitRange: interval,
							count: count,
					...
					Axis.prototype.getLogTickPositions = function (interval, min, max, minor) {
						...
						if (interval >= 0.5) {
							...
							interval = normalizeTickInterval(
								interval, null, getMagnitude(interval));
					...
					Tooltip.prototype = {
						...
						getPosition: function (boxWidth, boxHeight, point) {
							var chart = this.chart,
								...
								ret = {},
								swapped, first = ['y', chart.chartHeight, boxHeight, point.plotY + chart.plotTop],
						...
						refresh: function (point, mouseEvent) {
							var tooltip = this,
								...
								x, y, anchor, textConfig = {},
								text, pointConfig = [],
								formatter = options.formatter || tooltip.defaultFormatter,
								hoverPoints = chart.hoverPoints,
								borderColor, shared = tooltip.shared,
								currentSeries;
							clearTimeout(this.hideTimer);
					...
					Pointer.prototype = {
						...
						runPointActions: function (e) {
							var pointer = this,
								...
								anchor, noSharedTooltip, kdpoints = [],
								kdpoint, kdpointT;
					...
					Legend.prototype = {
						...
						init: function (chart, options) {
							var legend = this,
								...
								padding, itemMarginTop = options.itemMarginTop || 0;
							this.options = options;
							if (!options.enabled) {
								return;
							}
						...
						renderItem: function (item) {
							...
							if (!li) { // generate it once, later move it
								...
								item.legendItem = li = renderer.text(
										options.labelFormat ? format(options.labelFormat, item) : options.labelFormatter.call(item), ltr ? symbolWidth + symbolPadding : -symbolPadding, legend.baseline || 0, useHTML).css(merge(item.visible ? itemStyle : itemHiddenStyle)) // merge to prevent modifying original (#1021)
									.attr({
								...
								each([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (alignments, side) {
									if (alignments.test(alignment) && !defined(margin[side])) {
										...
										chart[marginNames[side]] = mathMax(
											chart[marginNames[side]], chart.legend[(side + 1) % 2 ? 'legendHeight' : 'legendWidth'] + [1, -1, -1, 1][side] * options[(side % 2) ? 'x' : 'y'] + pick(options.margin, 12) + spacing[side]);
									}
								});
							}
						},
					...
					var LegendSymbolMixin = Highcharts.LegendSymbolMixin = {
						...
						drawRectangle: function (legend, item) {
							...
							item.legendSymbol = this.chart.renderer.rect(
								0, legend.baseline - 5 - (symbolHeight / 2), legend.symbolWidth, symbolHeight, legend.options.symbolRadius || 0).attr({
								zIndex: 3
							}).add(item.legendGroup);
						},
						/**
						...
						drawLineMarker: function (legend) {
							var options = this.options,
								...
								legendSymbol, symbolWidth = legend.symbolWidth,
							...
							if (options.lineWidth) {
								...
								M, 0, verticalCenter, L, symbolWidth, verticalCenter]).attr(attr).add(legendItemGroup);
							}
							// Draw the marker
							if (markerOptions && markerOptions.enabled !== false) {
								radius = markerOptions.radius;
								this.legendSymbol = legendSymbol = renderer.symbol(
									this.symbol, (symbolWidth / 2) - radius, verticalCenter - radius, 2 * radius, 2 * radius).add(legendItemGroup);
					...
					Chart.prototype = {
						...
						isReadyToRender: function () {
							...
							/*jslint eqeq: true*/
							if ((!hasSVG && (win == win.top && doc.readyState !== 'complete')) || (useCanVG && !win.canvg)) { /*jslint eqeq: false*/
								if (useCanVG) {
					...
					var CenteredSeriesMixin = Highcharts.CenteredSeriesMixin = {
						...
						getCenter: function () {
							...
							for (i = 0; i < 4; ++i) {
								...
								[plotWidth, plotHeight, smallestSize, positions[2]][i] * pInt(value) / 100 : pInt(value)) + (handleSlicingRoom ? slicingRoom : 0);
							}
							return positions;
						}
					};
					...
					Series.prototype = {
						...
						init: function (chart, options) {
							var series = this,
								eventType, events, chartSeries = chart.series,
						...
						setOptions: function (itemOptions) {
							...
							this.tooltipOptions = merge(
								defaultOptions.tooltip, defaultOptions.plotOptions[this.type].tooltip, userOptions.tooltip, userPlotOptions.series && userPlotOptions.series.tooltip, userPlotOptions[this.type] && userPlotOptions[this.type].tooltip, itemOptions.tooltip);
						...
						getExtremes: function (yData) {
							var xAxis = this.xAxis,
								...
								xMin = xExtremes.min,
								xMax = xExtremes.max,
								validValue, withinRange, dataMin, dataMax, x, y, i, j;
						...
						translate: function () {
							...
							var series = this,
								...
								plotX, plotY, lastPlotX, closestPointRangePx = Number.MAX_VALUE;
						...
						animate: function (init) {
							var series = this,
								chart = series.chart,
								clipRect, animation = series.options.animation,
								sharedClipKey;
						...
						drawPoints: function () {
							var series = this,
								...
								globallyEnabled = pick(
									seriesMarkerOptions.enabled, xAxis.isRadial, series.closestPointRangePx > 2 * seriesMarkerOptions.radius);
									...
									if (enabled && plotY !== UNDEFINED && !isNaN(plotY) && point.y !== null) {
										...
										if (graphic) { // update
											...
											point.graphic = graphic = chart.renderer.symbol(
												symbol, plotX - radius, plotY - radius, 2 * radius, 2 * radius, hasPointMarker ? pointMarkerOptions : seriesMarkerOptions).attr(pointAttr).add(markerGroup);
										}
									} else if (graphic) {
						...
						getAttribs: function () {
							var series = this,
								...
								pointStateOptionsHover, seriesColor = series.color,
								...
								points = series.points || [],
								// #927
								i, point, seriesPointAttr = [],
								pointAttr, pointAttrToOptions = series.pointAttrToOptions,
						...
						getGraphPath: function () {
							var series = this,
								graphPath = [],
								segmentPath, singlePoints = []; // used in drawTracker
					...
					Axis.prototype.renderStackTotals = function () {
						var axis = this,
							...
							renderer = chart.renderer,
							stacks = axis.stacks,
							stackKey, oneStack, stackCategory, stackTotalGroup = axis.stackTotalGroup;
					...
					Series.prototype.setPercentStacks = function () {
						...
						each([stackKey, '-' + stackKey], function (key) {
							var i = processedXData.length,
								x, stack, pointExtremes, totalFactor;
							while (i--) {
								x = processedXData[i];
							...
							each(props, function (prop) {
								...
								if (area) { // update
									...
									series[areaKey] = series.chart.renderer.path(areaPath).attr({
										fill: pick(
											prop[2], Color(prop[1]).setOpacity(pick(options.fillOpacity, 0.75)).get()),
										zIndex: 0 // #1069
									}).add(series.group);
								}
							});
					...
					var ColumnSeries = extendClass(Series, {
						...
						cropShoulder: 0,
						directTouch: true,
						// When tooltip is not shared, this series (and derivatives) requires direct touch/hover. KD-tree does not apply.
						...
						translate: function () {
							var series = this,
								...
								borderWidth = series.borderWidth = pick(
									options.borderWidth, series.closestPointRange * series.xAxis.transA < 2 ? 0 : 1 // #3635
								),
								yAxis = series.yAxis,
								threshold = options.threshold,
							...
							each(series.points, function (point) {
								var yBottom = pick(point.yBottom, translatedThreshold),
									...
									right, bottom, fromTop, barH = mathMax(plotY, yBottom) - barY;
							...
							each(series.points, function (point) {
								...
								if (plotY !== UNDEFINED && !isNaN(plotY) && point.y !== null) {
									...
									if (graphic) { // update
										...
										point.graphic = graphic = renderer[point.shapeType](shapeArgs).attr(borderAttr).attr(pointAttr).add(series.group).shadow(options.shadow, null, options.stacking && !options.borderRadius);
									}
								} else if (graphic) {
									point.graphic = graphic.destroy(); // #1269
								}
					...
					var PieSeries = {
						...
						updateTotals: function () {
							var i, total = 0,
								points, len, point, ignoreHiddenPoint = this.options.ignoreHiddenPoint;
							// Populate local vars
							points = this.points;
							len = points.length;
							// Get the total sum
						...
						translate: function (positions) {
							...
							var series = this,
								...
								start, end, angle, startAngle = options.startAngle || 0,
						...
						drawPoints: function () {
							...
							each(series.points, function (point) {
								...
								if (graphic) {
									...
									point.graphic = graphic = renderer[point.shapeType](shapeArgs).setRadialReference(series.center).attr(
					...
					Series.prototype.drawDataLabels = function () {
						var series = this,
							...
							str, dataLabelsGroup, renderer = series.chart.renderer;
					...
					if (seriesTypes.pie) {
						seriesTypes.pie.prototype.drawDataLabels = function () {
							var series = this,
								...
								plotWidth = chart.plotWidth,
								plotHeight = chart.plotHeight,
								connector, connectorPath, softConnector = pick(options.softConnector, true),
								distanceOption = options.distance,
								seriesCenter = series.center,
								radius = seriesCenter[2] / 2,
								centerY = seriesCenter[1],
								outside = distanceOption > 0,
								dataLabel, dataLabelWidth, labelPos, labelHeight, halves = [ // divide the points into right and left halves for anti collision
								[], // right
								[] // left
								],
								x, y, visibility, rankArr, i, j, overflow = [0, 0, 0, 0],
								// top, right, bottom, left
								sort = function (a, b) {
									return b.y - a.y;
								};
							...
							while (i--) {
								var slots = [],
									slotsLength, usedSlots = [],
									points = halves[i],
									pos, bottom, length = points.length,
									slotIndex;
								if (!length) {
									continue;
								}
					...
					(function (H) {
						...
						Chart.prototype.hideOverlappingLabels = function (labels) {
							var len = labels.length,
								label, i, j, label1, label2, intersectRect = function (pos1, pos2, size1, size2) {
									return !(
										pos2.x > pos1.x + size1.width || pos2.x + size2.width < pos1.x || pos2.y > pos1.y + size1.height || pos2.y + size2.height < pos1.y);
								};
							...
							for (i = 0; i < len; i++) {
								...
								for (j = i + 1; j < len; ++j) {
									label2 = labels[j];
									if (label1 && label2 && label1.placed && label2.placed && label1.newOpacity !== 0 && label2.newOpacity !== 0 && intersectRect(label1.alignAttr, label2.alignAttr, label1, label2)) {
					...
					var TrackerMixin = Highcharts.TrackerMixin = {
						...
						drawTrackerGraph: function () {
							var series = this,
								...
								singlePoint, i, onMouseOver = function () {
									if (chart.hoverSeries !== series) {
										series.onMouseOver();
									}
								},
					...
					extend(Point.prototype, {
						...
						setState: function (state, move) {
							var point = this,
								...
								chart = series.chart,
								radius, halo = series.halo,
								haloOptions, newSymbol, pointAttr;
							...
							if (point.graphic) {
								...
								point.graphic.attr(merge(
									pointAttr, radius ? { // new symbol attributes (#507, #612)
										x: plotX - radius,
										y: plotY - radius,
										width: 2 * radius,
										height: 2 * radius
									...
									if (!stateMarkerGraphic) {
										if (newSymbol) {
											series.stateMarkerGraphic = stateMarkerGraphic = chart.renderer.symbol(
												newSymbol, plotX - radius, plotY - radius, 2 * radius, 2 * radius).attr(pointAttr).add(series.markerGroup);
						...
						haloPath: function (size) {
							...
							return chart.renderer.symbols.circle(
								plotBox.translateX + (inverted ? series.yAxis.len - this.plotY : this.plotX) - size, plotBox.translateY + (inverted ? series.xAxis.len - this.plotX : this.plotY) - size, size * 2, size * 2);
						}
					});
					/*
		...
		"/Users/justin.secor/Projects/Nextweb/js/vendor/highcharts/js/adapters/standalone-framework.src.js": 19
	}],
		...
		(function (g) {
			...
			j(["fill", "stroke"], function (b) {
				HighchartsAdapter.addAnimSetter(b, function (a) {
					a.elem.attr(b, y(g.Color(a.start), g.Color(a.end), a.pos))
				})
			});
			k(n.lang, {
			...
			g.SVGRenderer.prototype.Element.prototype.fadeIn = function (b) {
				this.attr({
					opacity: 0.1,
					visibility: "inherit"
				}).animate({
					opacity: s(this.newOpacity, 1)
				}, b || {
					duration: 250
				})
			};
			...
			h.prototype.addSingleSeriesAsDrilldown = function (b, a) {
				...
				j(c.chart.series, function (a) {
					if (a.xAxis === e) g.push(a), a.options._ddSeriesId = a.options._ddSeriesId || w++, a.options._colorIndex = a.userOptions._colorIndex, x.push(a.options), a.options._levelNumber = a.options._levelNumber || h
				});
				d = {
					levelNumber: h,
			...
			h.prototype.applyDrilldown = function () {
				var b = this.drilldownLevels,
					a;
				if (b && b.length > 0) a = b[b.length - 1].levelNumber, j(this.drilldownLevels, function (b) {
			...
			h.prototype.showDrillUpButton = function () {
				...
				this.drillUpButton ? this.drillUpButton.attr({
					text: a
				}).align() : (f = (e = c.theme) && e.states, this.drillUpButton = this.renderer.button(a, null, null, function () {
					b.drillUp()
				}, e, f && f.hover, f && f.select).attr({
					align: c.position.align,
					zIndex: 9
				}).add().align(c.position, !1, c.relativeTo || "plotBox"))
			};
			h.prototype.drillUp = function () {
				for (var b = this, a = b.drilldownLevels, c = a[a.length - 1].levelNumber, e = a.length, f = b.series, d, i, g, h, k = function (a) {
						var c;
						j(f, function (b) {
				...
				if (!b) {
					...
					setTimeout(function () {
						a.points && j(a.points, function (a, b) {
							var d = b === (c && c.pointIndex) ? "show" : "fadeIn",
								i = d === "show" ? !0 : void 0;
			...
			l.prototype.animateDrilldown = function (b) {
				var a = this,
					...
					e, f = this.chart.options.drilldown.animation,
					d = this.xAxis;
				if (!b) j(c, function (b) {
			...
			l.prototype.animateDrillupFrom = function (b) {
				...
				j(this.points, function (e) {
					...
					d && (delete e.graphic, a ? d.animate(k(b.shapeArgs, {
						fill: b.color
					}), g.merge(a, {
						complete: i
					})) : (d.attr(b.shapeArgs), i()))
				})
			};
			t && k(t.prototype, {
				supportsDrilldown: !0,
				...
				animateDrilldown: function (b) {
					...
					if (!b) j(this.points, function (b, h) {
						b.graphic.attr(g.merge(e, {
							start: f + h * d,
							end: f + (h + 1) * d,
							fill: a.color
						}))[c ? "animate" : "attr"](k(b.shapeArgs, {
							fill: b.color
						}), c)
					}), this.animate = null
				}
			...
			g.Point.prototype.doDrilldown = function (b, a) {
				for (var c = this.series.chart, e = c.options.drilldown, f = (e.series || []).length, d; f-- && !d;) e.series[f].id === this.drilldown && v(this.drilldown, p) === -1 && (d = e.series[f], p.push(this.drilldown));
				u(c, "drilldown", {
					point: this,
					seriesOptions: d,
					category: a,
			...
			g.Axis.prototype.drilldownCategory = function (b) {
				j(this.ticks[b].label.ddPoints, function (a) {
					a.series && a.series.visible && a.doDrilldown && a.doDrilldown(!0, b)
				});
			...
			o(g.Point.prototype, "init", function (b, a, c, e) {
				...
				if (f.drilldown) {
					if (g.addEvent(f, "click", function () {
						...
						c.addClass("highcharts-drilldown-axis-label").css(b.options.drilldown.activeAxisLabelStyle).on("click", function () {
							a.xAxis.drilldownCategory(e)
						});
						c.ddPoints.push(f);
						c.levelNumber = a.options._levelNumber
					}
				} else if (c && c.basicStyles && c.levelNumber !== a.options._levelNumber) c.styles = {}, c.css(c.basicStyles), c.on("click", null);
				return f
			});
	...
	22: [function (require, module, exports) {
		(function (global) {
			...
			(function () { /** Used as a safe reference for `undefined` in pre ES5 environments */
				...
				var arrayPool = [],
					objectPool = []; /** Used to generate unique IDs */
				...
				var argsClass = '[object Arguments]',
					...
					stringClass = '[object String]'; /** Used to identify object classifications that `_.clone` supports */
				var cloneableClasses = {};
				cloneableClasses[funcClass] = false;
				cloneableClasses[argsClass] = cloneableClasses[arrayClass] = cloneableClasses[boolClass] = cloneableClasses[dateClass] = cloneableClasses[numberClass] = cloneableClasses[objectClass] = cloneableClasses[regexpClass] = cloneableClasses[stringClass] = true; /** Used as an internal `_.debounce` options object */
				var debounceOptions = {
					'leading': false,
					'maxWait': 0,
					'trailing': false
				...
				function runInContext(context) {
					...
					var ceil = Math.ceil,
						...
						unshift = arrayRef.unshift; /** Used to set meta data on functions */
					...
					var nativeCreate = isNative(nativeCreate = Object.create) && nativeCreate,
						...
						nativeRandom = Math.random; /** Used to lookup a built-in constructor by [[Class]] */
					var ctorByClass = {};
